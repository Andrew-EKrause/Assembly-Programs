...
## Mars (IDE)
1. NOTE: For additional visual assistance, see the screenshots below under the "Examples / Screenshots for Setting up Mars Environment" section. You can access this section by scrolling down this page or clicking on the link: [Examples / Screenshots for Setting up Mars Environment](#Examples / Screenshots for Setting up Mars Environment).
